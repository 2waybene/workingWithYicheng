##==============================================================
##  FileName: clean_olk_sample_single.R
##  Modified from: DI2rda_v2.R
##  Author: Jianying Li
...
##		Now, works (v2) perfectly fine with OSCC data!!
##=============================================================
...
rawFiles <- list.files (paste(root, "myGit/workingWithYicheng/phase-II-data/OLK/",sep=""), pattern = "csv")
rawFiles
