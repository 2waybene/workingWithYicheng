...
##=================================================
##  must run reconstruct function at the end!!
##=================================================
...
dt.dir <- paste (root, "/myGit/workingWithYicheng/phase-II-data/clearnedData/Normal/", sep="")
## But we do NOT have normal data in the second phase
...
## This is for phase II 
dt.dir <- paste (root, "/myGit/workingWithYicheng/phase-II-data/clearnedData/OSCC/", sep="")
...
# No normal data in the second batch
